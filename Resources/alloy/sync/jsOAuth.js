...
exports.OAuth = function(a) {
    ...
    function l() {
        var b;
        if (typeof a.Titanium != "undefined" && typeof a.Titanium.Network.createHTTPClient != "undefined") b = a.Titanium.Network.createHTTPClient(); else if (typeof require != "undefined") try {
            b = (new require("xhr")).XMLHttpRequest();
        } catch (c) {
            if (typeof a.XMLHttpRequest == "undefined") throw "No valid request transport found.";
    ...
    c.prototype = {
        ...
        } else for (d = 0; d < c; d += 2) g[b[d]] = b[d + 1];
    };
    var f = "1.0";
    return g.prototype = {
        realm: "",
        ...
        init: function(a) {
            ...
            return this.realm = a.realm || b, this.requestTokenUrl = a.requestTokenUrl || b, this.authorizationUrl = a.authorizationUrl || b, this.accessTokenUrl = a.accessTokenUrl || b, this.getAccessToken = function() {
                ...
                for (r in z) y[r] = z[r];
                if ((!("Content-Type" in n) || n["Content-Type"] == "application/x-www-form-urlencoded") && !A) for (r in m) y[r] = m[r];
                ...
                if (x || b == "GET") e.query.setQueryParams(m), w = null; else if (!A) if (typeof m == "string") w = m, "Content-Type" in n || (n["Content-Type"] = "text/plain"); else {
